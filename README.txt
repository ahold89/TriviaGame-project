...
(Levels: Easy [1 point per correct answer], 
		 Medium [2 points per correct answer],
		 Hard [3 point per correct answer];
 Categories: Music, Sports, Science, Geography and General) => Each category of each level has 10 questions (Total: 150 questions)
